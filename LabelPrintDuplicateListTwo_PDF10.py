...
PARTNER_FILE_NAMES = {
    "PWR0000006": "LabelPrintDuplicateListTwo_standard_PDF10.pdf",
    "TEST000859": "LabelPrintDuplicateListTwo_meest_PDF10.pdf",
    "TEST003483": "LabelPrintDuplicateListTwo_Vinted_PDF10.pdf",
}
...
if __name__ == "__main__":
    ...
    method_folder_name = "LabelPrintDuplicateListTwo_PDF10"
    ...
    try:
        for url_name, url_value in URL_DICT.items():
            for partner_id, partner_key in partners:
                ...
                decode_and_save_pdf10(response_data[0], response_data[1], OUTPUT_FOLDER,
