...
PARTNER_FILE_NAMES = {
    "PWRTR50301": "label_allegro_GenerateLabelBusinessPackList.pdf",
}
...
<soap:Envelope xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
  <soap:Body>
     <GenerateLabelBusinessPackAllegro xmlns="https://91.242.220.103/WebServicePwR">
      <PartnerID>{partner_id}</PartnerID>
      <PartnerKey>{partner_key}</PartnerKey>
     <DestinationCode>WS-100001-27-26</DestinationCode>
      <AlternativeDestinationCode>WS-100001</AlternativeDestinationCode>
...
if __name__ == "__main__":
    ...
    method_folder_name = "label_GenerateLabelBusinessPackAllegro"
    ...
    # Słownik z nazwami plików dla partnerów
    PARTNER_FILE_NAMES = {
        "PWRTR50301": "etykieta_PWRTR50301.pdf",
    }
    ...
    try:
        for partner_id, partner_key in partners:
            ...
            decode_and_save_pdf(label_base64, main_folder, method_folder_name, PARTNER_FILE_NAMES[partner_id])
