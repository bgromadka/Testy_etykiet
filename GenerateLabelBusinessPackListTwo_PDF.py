...
PARTNER_FILE_NAMES = {
    "PWR0000006": "GenerateLabelBusinessPackListTwo__standard__PDF.pdf",
    "TEST000859": "GenerateLabelBusinessPackListTwo__Meest__PDF.pdf",
    "TEST003483": "GenerateLabelBusinessPackListTwo__Vinted__PDF.pdf",
}
...
def decode_and_save_pdf(base64_data, pack_code, main_folder, method_folder_name, output_filename, url_name):
    ...
    try:
        ...
        if base64_data is None:
            ...
            print(f"Długość danych PDF: {len(data)} bajtów")
...
if __name__ == "__main__":
    ...
    method_folder_name = "GenerateLabelBusinessPackListTwo_PDF"
