...
PARTNER_FILE_NAMES = {
    "PWR0000006": "GenerateLabelBusinessPackListTwo__standard__EPL.epl",
    "TEST000859": "GenerateLabelBusinessPackListTwo__meest__EPL.epl",
    "TEST003483": "GenerateLabelBusinessPackListTwo__Vinted__EPL.epl",
}
...
if __name__ == "__main__":
    ...
    method_folder_name = "GenerateLabelBusinessPackListTwo_EPL"
    ...
    try:
        ...
        for url_name, url_value in URL_DICT.items():
            for partner_id, partner_key in partners:
                ...
                decode_and_save_EPL(label_base64, OUTPUT_FOLDER, method_folder_name, output_filename, url_name)
